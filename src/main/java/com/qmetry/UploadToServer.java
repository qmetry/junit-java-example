...
public class UploadToServer {
	...
	public static void uploadToTheServer(String apikeyserver, String jiraurlserver, String password,
			...
			String componentserver, String username, String fileserver, String platformserver, String commentserver,
			String testAssetHierarchy, String testRunKey)
			throws InvalidCredentialsException, ProtocolException, IOException {
		String selectionserver = "junit/xml";
		CloseableHttpClient httpClient = HttpClients.createDefault();
		String toEncode = username + ":" + password;
		// byte[] encodedBytes =
		// Base64.getEncoder().encode(toEncode.getBytes(StandardCharsets.UTF_8));
